...
exports.concat = {
    dist: {
        files: [
            {
                'tool/grunt/temp/core.js': coreFiles,
                'tool/grunt/temp/basic.js': basicFiles,
                'tool/grunt/temp/ui.js': uiFiles,
                'tool/grunt/temp/cmd.js': cmdFiles,
                'tool/grunt/temp/init.js': initFiles
            },
            {
                'tool/grunt/temp/webvn.css': uiCssFiles
            }]
    }
};
