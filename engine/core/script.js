/* The WebVN script controller.
 * Include lexer, javascript eval and a bunch of other things
 * for controlling the scripts.
 * Note: the parser is generated by jison.
 */

webvn.add('script', ['parserNew', 'parserNode', 'class', 'util', 'log', 'config', 'loader'],
    function (s, parser, parserYy, kclass, util, log, config, loader) {
         ...
         * LocationData is {first_line, first_column, last_line, last_column}
         */
        var Token = kclass.create({
        ...
        function execCommand(command) {
            ...
            var command = parseCommand(command[1]);
